...
public class MainActivity extends AppCompatActivity {
    ...
    /*public void getSpeechInput(View view) {
        Intent intentt = new Intent(RecognizerIntent.ACTION_RECOGNIZE_SPEECH);
        ...
        if (intentt.resolveActivity(getPackageManager()) != null) {
            startActivityForResult(intentt, 10);
        } else {
            Toast.makeText(this, "Your android device Don't support speech input", Toast.LENGTH_LONG).show();
        }
